...
# pip install pydub
# Также требуется ffmpeg или avlib — убедись, что установлен

'''
Скрипт, который автоматически делит длинное аудио (например, подкаст или лекцию) на главы по паузам или тишине. Удобно
для разбиения больших треков и подготовки фрагментов для публикации, разбивки на главы или последующей расшифровки.
