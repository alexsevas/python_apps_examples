...
# Скрипт, который превращает изображения в аккуратный ASCII-арт прямо в терминале или сохраняет результат в .txt файле
# python ascii_art.py --input image_cr.jpg --width 99 --output ascii.txt --detailed
...
- Включает CLI‑интерфейс для настройки ширины и 'яркости'.
'''