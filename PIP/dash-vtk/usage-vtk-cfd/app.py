...
# pip install dash >= 1.19.0 dash-vtk dash-bootstrap-components pyvista numpy vtk

# The goal of that example is to show you how you can use PyVista/VTK to load and process some CFD dataset and
# dynamically adjust some filter parameters and render the result in a 3D Web view using dash-vtk.
