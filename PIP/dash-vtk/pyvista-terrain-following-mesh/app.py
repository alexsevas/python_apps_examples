...
# pip install dash dash-vtk dash-bootstrap-components numpy vtk

'''
Demo of Terrain deformation using PyVista and dash-vtk.
The goal of that example is to show you how you can use PyVista to get a mesh and transform it using dash-vtk for
its rendering.
'''
